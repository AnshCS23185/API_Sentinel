      ...
      <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#111827] text-xs sm:text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#D44720] transition-all"
          />
          {search && (
            <button
              onClick={() => setSearch('')}
        ...
        <div className="flex items-center gap-3 shrink-0 justify-between sm:justify-end">
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#111827] px-3 py-2 text-xs text-slate-800 dark:text-slate-200 font-medium focus:outline-none focus:ring-1 focus:ring-[#D44720]"
            >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 divide-x divide-slate-200 dark:divide-slate-800/80 gap-2 sm:gap-0">
          <div className="flex items-center gap-3 px-2 sm:px-4 first:pl-0">
            ...
            <div>
              ...
              <span className="text-[11px] text-slate-400 font-medium">Total APIs</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 px-2 sm:px-4">
            ...
            <div>
              ...
              <span className="text-[11px] text-slate-400 font-medium">Connected</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 px-2 sm:px-4">
            ...
            <div>
              ...
              <span className="text-[11px] text-slate-400 font-medium">Total Endpoints</span>
            </div>
          </div>
        </div>
      </div>

      {/* 3. MAIN CATALOG & FILTERS GRID (2-Column Layout matching Reference Image) */}
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3 space-y-4">
          {filteredApis.length > 0 ? (
            <div className="space-y-3">
              {filteredApis.map((api) => (
                <div
                  ...
                  className="group rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#111827] p-5 hover:border-slate-300 dark:hover:border-slate-700 transition-all cursor-pointer shadow-xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4"
                >
                  {/* Left: Icon, Name, Path, Description, Metadata */}
                  <div className="flex items-start gap-4 min-w-0 flex-1">
                    <div className="p-3 rounded-xl bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shrink-0">
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-6 w-full sm:w-auto border-t sm:border-t-0 border-slate-100 dark:border-slate-800/80 pt-3 sm:pt-0 shrink-0">
                    ...
                    <div className="flex items-center gap-2">
                      <Button
                        variant="outline"
                        size="sm"
                        className="group-hover:border-[#D44720] group-hover:text-[#D44720] transition-colors"
                        onClick={(e) => {
                          e.stopPropagation()
                          setSelectedApi(api)
                        }}
            ...
            /* Empty State */
            <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#111827] p-12 text-center space-y-3">
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#111827] p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 shadow-xs">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="text-xs font-bold text-slate-900 dark:text-slate-100">Don't see the API you need?</h4>
                <p className="text-[11px] text-slate-500">Contact your administrator to request access to additional APIs.</p>
              </div>
            </div>
            ...
            <Button
              ...
              className="border-slate-300 dark:border-slate-700 hover:border-[#D44720] shrink-0"
            >
        ...
        {/* RIGHT SIDEBAR: Filters Panel (Matching reference image) */}
        <div className="space-y-4">
          <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#111827] p-5 space-y-5 shadow-xs">
