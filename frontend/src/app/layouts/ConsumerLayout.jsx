  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden bg-app-bg text-main-color">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {mobileMenuOpen && (
          <div className="fixed inset-0 z-50 flex md:hidden bg-slate-950/60 backdrop-blur-xs">
            <div className="relative w-64">
              <Sidebar portalType="consumer" onCloseMobile={() => setMobileMenuOpen(false)} />
              <button
        ...
        <main className="flex-1 overflow-y-auto lg:overflow-hidden p-2 sm:p-3 lg:px-5 lg:py-2.5">
